...
public class PermissionMgr {
    private static final com.example.sharedqq.PermissionMgr sInstance = new com.example.sharedqq.PermissionMgr();
    ...
    public static com.example.sharedqq.PermissionMgr getInstance() {
        return sInstance;
    }
